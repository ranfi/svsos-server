			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-extended dropdown-tasks"
					...
					<ul class="dropdown-menu extended tasks">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								<li><a href="page_todo.html"> <span class="task">
						...
						<li class="external"><a href="page_todo.html"> See all
								tasks <i class="icon-arrow-right"></i>
						</a></li>
					</ul></li>
				<!-- END TODO DROPDOWN -->
				...
				<li class="dropdown dropdown-user"><a href="#"
					...
					data-hover="dropdown" data-close-others="true"> <img alt=""
						...
						src="${ctx}/static/img/avatar3_small.jpg" /> <span
						class="username username-hide-on-mobile">
							<shiro:user>你好, <shiro:principal property="name"/> </shiro:user></span> <i
					...
					<ul class="dropdown-menu">
						...
						<li><a href="page_todo.html"> <i class="icon-rocket"></i>
								我的任务 <span class="badge badge-success"> 7 </span>
						</a></li>
						<li class="divider"></li>
