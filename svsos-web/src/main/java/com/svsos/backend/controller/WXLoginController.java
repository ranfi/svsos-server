...
public class WXLoginController {
	...
	public String weixinlogin(Response response , Request request ,Model model) {
	...
	public String weixinlogin(Response response , Request request ,Model model,RedirectAttributes redirectAttr) throws UnsupportedEncodingException{		
